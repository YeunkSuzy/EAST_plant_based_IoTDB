...
def parameter_choice(table_name, cursor):
        ...
        elif table_name == "proj_data_db":
            data_type_lsts = [TSDataType.INT32, TSDataType.TEXT, TSDataType.FLOAT, TSDataType.TEXT, TSDataType.INT32, TSDataType.INT32, TSDataType.TEXT, TSDataType.INT32, TSDataType.TEXT]
